...
public class WorkspaceRuntimes {
    ...
    public RuntimeDescriptor start(WorkspaceImpl workspace, String envName, boolean recover) throws ServerException,
        ...
        try {
            ...
            final MachineConfigImpl devCfg = rmFirst(activeEnv.getMachineConfigs(), MachineConfig::isDev);
            activeEnv.getMachineConfigs().add(0, devCfg);
            final Queue<MachineConfigImpl> queue = new ArrayDeque<>(activeEnv.getMachineConfigs());
    ...
    public static class RuntimeDescriptor {
        ...
        RuntimeDescriptor(WorkspaceRuntimeImpl runtime) {
            this.runtime = runtime;
        }

        RuntimeDescriptor(RuntimeDescriptor descriptor) {
